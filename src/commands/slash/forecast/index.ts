...
export default ({
	data: new SlashCommandBuilder()
		.setName('forecast')
		.setDescription('Weather forecast commands')
		.addSubcommand(sc => sc
			.setName('add')
			.setDescription('Designate a channel for posting weather forecasts to')
			.addNumberOption(o => o
				.setName('latitude')
		...
		.addSubcommand(sc => sc
			.setName('remove')
			.setDescription('Removes forecast reporting')
			.addStringOption(o => o
				.setName('snowflake')
				.setDescription('The snowflake associated with the forecast reporting you want to remove')
				.setRequired(true)))
		.addSubcommand(sc => sc
			.setName('list')
			.setDescription('Lists all forecast reporting destinations in this server'))
