...
export const env = Env.create({
	...
	MAX_EARTHQUAKE_SUBSCRIPTIONS_PER_GUILD:  Env.schema.int({ positive: true, defaultValue: 5 }),
	EARTHQUAKE_PUBLICATION_ENABLED:          Env.schema.boolean({ defaultValue: false }),
});
