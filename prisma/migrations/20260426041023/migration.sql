...
INSERT INTO "new_AutoRadarMessage" ("channelId", "guildId", "id", "location", "messageId", "nextUpdate", "radarImageUrl", "radarStation", "snowflake", "velocityRadarImageUrl") SELECT "channelId", "guildId", "id", "location", "messageId", "nextUpdate", "radarImageUrl", "radarStation", "snowflake", "velocityRadarImageUrl" FROM "AutoRadarMessage";
