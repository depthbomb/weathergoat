...
CREATE TABLE "new_AutoRadarMessage" (
    ...
    "updateInterval" TEXT NOT NULL DEFAULT '5m',
    "nextUpdate" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP
);
INSERT INTO "new_AutoRadarMessage" ("channelId", "guildId", "id", "location", "messageId", "nextUpdate", "radarImageUrl", "radarStation", "showReflectivity", "showVelocity", "snowflake", "velocityRadarImageUrl") SELECT "channelId", "guildId", "id", "location", "messageId", "nextUpdate", "radarImageUrl", "radarStation", "showReflectivity", "showVelocity", "snowflake", "velocityRadarImageUrl" FROM "AutoRadarMessage";
